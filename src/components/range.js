...
class Range extends Component{
  constructor(props){
	...
	componentWillMount(){
		fetch('/getRange').then(data => data.json())
		.then(data => {
			this.setState({
				cars: data,
			})
	...
	render(){
		return(
			...
			<h3 style={{fontSize: '35px', textAlign: 'center'}}>Range Rover</h3>
        ...
        <DialogActions>
          <Button href="/range" color="primary" onClick={this.snedTD.bind(this)}>Request Test Drive</Button>
